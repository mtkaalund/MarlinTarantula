 ...
 */
#define  bed_Kp 264.57
#define  bed_Ki 52.09
#define  bed_Kd 335.97
...
#define STRING_CONFIG_H_AUTHOR "(Michael Torp Kaalund, TEVO Tarantula config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TEVO MTK"
